...
<head>
    ...
    <meta name="description" content="Sandy Mandell — A Children's Book for Seniors">
    <title>Sandy Mandell | A Children's Book for Seniors</title>
...
<body>
    <header class="site-header position-absolute top-0 start-0 w-100 z-3">
        <nav class="navbar navbar-expand-lg" aria-label="Primary navigation">
            <div class="container site-container">
                <a class="navbar-brand" href="#home"><img src="assets/images/logo.png" alt="Sandy Mandell"></a>
